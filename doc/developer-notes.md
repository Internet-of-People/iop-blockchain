...
Run with the -testnet option to run with "play IoPs" on the test network, if you
...
- ThreadSocketHandler : Sends/Receives data from peers on port 4877.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 8337 for connections and services them.
