IoP-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/IoP/files/IoP/IoP-0.8.2/
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the IoP-Qt debug
console will cause IoP-Qt to crash. Run IoP-Qt with the -server command-line
