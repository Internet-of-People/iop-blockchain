IoP version 0.7.1 is now available from:
  http://sourceforge.net/projects/IoP/files/IoP/IoP-0.7.1/
...
* Clicking on a IoP: URI on Windows should now launch IoP-Qt properly.

* When running -testnet, use RPC port 18337 by default.
