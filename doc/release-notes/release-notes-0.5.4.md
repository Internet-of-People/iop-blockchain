IoP version 0.5.4 is now available for download at:
http://sourceforge.net/projects/IoP/files/IoP/IoP-0.5.4/
...
http://gitorious.org/IoP/IoPd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix IoP-Qt notifications under Growl 1.3.
Increase required age of IoP-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxIoP properly when installing IoP-Qt over it. (Windows)
