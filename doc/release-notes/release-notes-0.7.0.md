IoP version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/IoP/files/IoP/IoP-0.7.0/

We recommend that everybody running prior versions of IoPd/IoP-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/IoP/IoP/tarball/v0.7.0  # .tar.gz
  https://github.com/IoP/IoP/zipball/v0.7.0  # .zip
...
IoP Improvement Proposals implemented
...
Core IoP handling and blockchain database
...
* Ensure a changed IoP unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for IoP-qt.exe
* (Windows only): add meta-data to IoP-qt.exe (e.g. description)
...
* Bash programmable completion for IoPd(1)
