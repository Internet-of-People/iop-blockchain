IoP-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/IoP/files/IoP/IoP-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the IoP
...
New/changed settings (command-line or IoP.conf file)
--------------------------------------------------------
