Download URL: https://sourceforge.net/projects/IoP/files/IoP/IoP-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 IoP fee schedule (users still pay 0.01 IoP per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #IoP00 - #IoP99
