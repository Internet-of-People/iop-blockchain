...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CIoPAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CIoPAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CIoPAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CIoPAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CIoPAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CIoPAddress(arr[0].get_str()).Get() == demoAddress.Get());
