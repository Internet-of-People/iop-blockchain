...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. IoP_de.qm (shortcut "de" needs to be defined in IoP.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. IoP_de_DE.qm (shortcut "de_DE" needs to be defined in IoP.qrc)
    ...
    returnValue(0)
{
    ...
    platformName = GetArg("-uiplatform", IoPGUI::DEFAULT_UIPLATFORM);
...
void IoPApplication::initializeResult(int retval)
{
...
void IoPApplication::shutdownResult(int retval)
{
