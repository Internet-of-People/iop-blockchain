...
QT_TRANSLATE_NOOP("IoP-core", "Connect only to the specified node(s)"),
...
QT_TRANSLATE_NOOP("IoP-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
...
QT_TRANSLATE_NOOP("IoP-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("IoP-core", "Invalid -proxy address: '%s'"),
...
QT_TRANSLATE_NOOP("IoP-core", "Loading addresses..."),
...
QT_TRANSLATE_NOOP("IoP-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
...
QT_TRANSLATE_NOOP("IoP-core", "Transaction amounts must be positive"),
...
QT_TRANSLATE_NOOP("IoP-core", "Verifying wallet..."),
